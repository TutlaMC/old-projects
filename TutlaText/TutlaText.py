...
file_menu.add_command(label="Save As", command=saveAs_file,accelerator="(Ctrl+Shift+S)")
file_menu.add_separator()
file_menu.add_command(label="Print", command=print_file,accelerator="(Ctrl+Shift+P)")
file_menu.add_separator()
...
edit_menu.add_command(label="Redo", command=text_area.edit_redo,accelerator="(Ctrl+yY")
edit_menu.add_separator()
edit_menu.add_command(label="Select All",command=selectAT,accelerator="(Ctrl+Z)")
edit_menu.add_command(label="Clear",command=clearAT,accelerator="(Ctrl+A+Backspace)")
